...
def test_main(mock_create_integration: Mock, mock_prompt: Mock, mock_sys: Mock, capsys):
    ...
    mock_prompt.return_value.prompt.return_value = 'param2'
...
@patch('fuzzy_secret_stdout.__main__.FzfPrompt')
@patch('fuzzy_secret_stdout.__main__.create_integration')
def test_main_nothing_selected(mock_create_integration: Mock, mock_prompt: Mock, mock_sys: Mock, capsys):
    ...
    mock_prompt.return_value.prompt.return_value = []
    mock_sys.argv = ['script']
